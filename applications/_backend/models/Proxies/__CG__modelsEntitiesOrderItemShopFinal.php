 ...
 */
class ItemShopFinal extends \models\Entities\Order\ItemShopFinal implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setReview(\models\Entities\ReviewStore $value)
    {
        $this->__load();
    ...
    public function setOrder(\models\Entities\OrderShopFinal $value)
    {
        $this->__load();
