 ...
 */
class Brand extends \models\Entities\Product\Brand implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'image', 'featured', 'position', 'status');
    }
