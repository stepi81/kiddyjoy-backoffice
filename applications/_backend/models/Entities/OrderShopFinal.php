 ...
 */
 ...
 /**
  * @Entity
  * @Table(name="ecom_orders_shop_final")
  */
 class OrderShopFinal {
	...
	/**
     * @OneToMany(targetEntity="models\Entities\Order\ItemShopFinal", mappedBy="order")
	 * @OrderBy({"price" = "DESC"})
     */
	private $items;
	...
	public function getUsedPoints() { return ''; }
 ...
 /* End of file OrderShopFinal.php */
 /* Location: ./system/applications/_frontend/models/Entities/OrderShopFinal.php */