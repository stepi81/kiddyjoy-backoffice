    ...
    <ul>
        <li>
            ...
            <div class="innerContent">
                ...
                <form id="subcategoryForm" method="post" action="<?= site_url( 'product/subcategories/edit_subcategory/' . $subcategory->getID()) ?>" enctype="multipart/form-data">
                    <fieldset class="sectionForm">
                        ...
                        <ul>
                            ...
                            <li>
                                <label>Pozicija podkategorije:</label>
