                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                 <td>
                                    ...
                                    <p style="font-family:'Ubuntu', Arial, Helvetica, sans-serif; font-size:11px; color:#737272; margin-bottom:10px;">
                                    	Vaš odgovor na pitanje vezano za <?= $question->getProduct()->getName() ?> je odobren od strane administratora i poslat korisniku koji ga je postavio.
                                    </p>
                                    <p style="font-family:'Ubuntu', Arial, Helvetica, sans-serif; font-size:11px; color:#737272; margin-bottom:10px;">
                                    	Kliknite <a href="<?= ECOM_APP_URL.'uslovi_koriscenja' ?>" >OVDE</a> i upoznajte se sa pravilnikom uslova koje morate ispuniti da bi odgovor bio odobren.<br />	
                                    </p>
                                    
                                    <p style="font-family:'Ubuntu', Arial, Helvetica, sans-serif; font-size:11px; color:#737272; margin-bottom:10px;">
                                    	Odgovor koji ste napisali je:	
                                    </p>
                                    <p style="font-family:'Ubuntu', Arial, Helvetica, sans-serif; font-size:11px; color:#737272; margin-bottom:10px;">
                                    	<?= $answer->getAnswer(); ?><br />
                                    </p>
