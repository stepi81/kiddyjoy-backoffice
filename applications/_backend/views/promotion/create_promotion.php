    ...
    <ul>
        <li>
            ...
            <div class="innerContent">
                ...
                <form id="promotionForm" method="post" action="<?= site_url( 'promotions/save' ) ?>" enctype="multipart/form-data">
                    ...
                    <div class="borderTop">
                        ...
                        <span class="button save">
                            <input type="button" value="Nastavi" onclick="validateForm('promotionForm')" /> 
